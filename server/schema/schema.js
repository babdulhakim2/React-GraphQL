...
//   {name: 'The Colour of Magic', genre:'Fatancy', id:'5', authorId:'3'},
//   {name: 'The Light Fantastic', genre:'Fantacy', id:'6', authorId:'3'}
// ]
//
// var authors = [
//   {name: 'Patirck Rothfuss', 'age':44, id:"1"},
//   {name: 'Brandon Sanderson', 'age':42, id:"2"},
//   {name: 'Terry Prstchett', 'age':66, id:"3"}
// ];
  ...
  fields:() =>({
    ...
    author:{
      ...
      resolve(parent, args){
        ...
        return Author.findById(parent.authirId)
      }
    }
  })
});
...
const Mutation = new GraphQLObjectType({
  ...
  fields:{
    addAuthor:{
      ...
      resolve(parent, args){
        //creates new instance of Author
